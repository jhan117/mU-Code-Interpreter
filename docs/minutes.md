...
- [회의록](#회의록)
	...
	- [2025-12-01 (오후 2시 도서관 1층)](#2025-12-01-오후-2시-도서관-1층)
 	- [2025-12-02 (오후 1시 디관 빈강의실)](#2025-12-02-오후-1시-디지털관-빈강의실)
...
## 2025-12-01 (오후 2시 도서관 1층)
- 주요 논의사항
  - 결과 ppt 초안 확인
    - 변경점은 세분화해서 2개로 나누기 (실행/배포)
    - 전체 프로그램 구조와 프로그램 실행 흐름은 합치기 (도형은 조금 더 단순하게)
    - 향후 확장 추가(개선점: change 이슈)
    - 결과 분석 너무 좋음(벤치 마크 기능 추가)
    - 데모는 영상/배포 버전 실행 둘 다 준비(강의실에 우분투 실행 가능할지 모름)
    - 다른 환경에서 배포 파일 실행되는지 확인하기(친구 노트북으로 해보기로 결정)
  - 결과 ppt 목차 결정
    1. 프로그램 개요
    2. 프로그램 구조 및 기능
    3. 설계 변경점 (실행/배포)
  ...
  - 결과 ppt 역할 분담
    - 권기영: 프로그램 개요 ~ 설계 변경점
    - 이강석: 프로그램 데모 ~ 향후 확장
  - 다음 회의 일정: 12-02 오후 1시 발표 연습
 
## 2025-12-02 (오후 1시 디지털관 빈강의실)
- 한 일
  - 발표 대본 작성 후 시간 측정
  - 몇 번 발표 후 분량 조절함
- 다음 일정: 발표 당일 한 번 빠르게 맞춰보기 (진행함)
